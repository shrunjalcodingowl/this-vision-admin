...
import { EmailVisibilityFilters } from "../../../store/email/Action";
    ...
    <Box>
      ...
      <List sx={{ p: 1 }}>
        <FilterEmail
          icon="inbox"
          text="Inbox"
          filter={EmailVisibilityFilters.SHOW_INBOX}
        />
        <FilterEmail
          icon="send"
          text="Sent"
          filter={EmailVisibilityFilters.SHOW_SENT}
        />
        <FilterEmail
          icon="archive"
          text="Draft"
          filter={EmailVisibilityFilters.SHOW_SPAM}
        />
        <FilterEmail
          icon="flag"
          text="Spam"
          filter={EmailVisibilityFilters.SHOW_DRAFTS}
        />
        <FilterEmail
          icon="trash"
          text="Trash"
          filter={EmailVisibilityFilters.SHOW_TRASH}
        />
      </List>
      ...
      <List sx={{ p: 1 }}>
        <FilterEmail
          icon="star"
          text="Starred"
          filter={EmailVisibilityFilters.SHOW_STARRED}
        />
        <FilterEmail
          icon="alert-circle"
          text="Important"
      ...
      <List sx={{ p: 1 }}>
        ...
        <FilterEmail
          icon="disc"
          text="Social"
          filter={EmailVisibilityFilters.SHOW_SOCIAL}
        />
        <FilterEmail
          icon="disc"
          text="Health"
          filter={EmailVisibilityFilters.SHOW_HEALTH}
        />
      </List>
