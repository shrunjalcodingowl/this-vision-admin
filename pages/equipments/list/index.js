...
import Bookings from "../../../data/equipments/data";
...
const handleBlock = (row) => {
  Swal.fire({
    title: "Are you sure?",
    text: `Are you sure to unlist ${row.name}?`,
    icon: "warning",
    ...
    if (result.isConfirmed) {
      Swal.fire("Unlisted!", `${row.name} has been unlisted.`, "success");
    }
  });
};
  ...
  return (
    ...
    >
      ...
      <Box display="flex" alignItems="center" width="100%" gap={1}>
        ...
        <Box display="flex" justifyContent="flex-end" width="70%" gap={1}>
          <NextLink href="/equipments/add/">
            <Button color="primary" variant="contained">
              Add Equipment
            </Button>
          </NextLink>
                          ...
                          >
                            ...
                            <TableCell>
                              <Tooltip title="Edit">
                                <IconButton>
                                  <NextLink href="/equipments/add/">
                                    <FeatherIcon icon="edit-3" width="18" color="green" />
                                  </NextLink>
                                </IconButton>
                              </Tooltip>
                              <Tooltip title="Unlist Equipment">
