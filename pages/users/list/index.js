...
const handleBlock = (row) => {
  Swal.fire({
    title: "Are you sure?",
    text: `Are you sure to block ${row.name}?`,
    icon: "warning",
    ...
    if (result.isConfirmed) {
      Swal.fire("Blocked!", `${row.name} has been blocked.`, "success");
    }
  });
};
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell>
                              <Tooltip title="View">
                                <IconButton>
                                {/* <NextLink href={`/users/view/${row.email}`} passHref> */}
                                <NextLink href="/users/view/">
